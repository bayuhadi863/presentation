import screenshot from "../assets/codegen-generate.png";
import { slideCount } from ".";
import { formatPageNumber } from "./utils";
import type { SlideProps } from "./types";

export const codegenGenerateId = "codegen-generate";
export const codegenGenerateLabel = "Halaman Generate Code";
export const codegenGeneratePageNumber = 9;
...
export default function CodegenGenerateSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section className={presentationClass} aria-label="Generate Code Page">
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-emerald-200/60">
          {formatPageNumber(codegenGeneratePageNumber, slideCount)}
        </span>
      </div>
