import screenshot from "../assets/codegen-result.png";
import { slideCount } from ".";
import { formatPageNumber } from "./utils";
import type { SlideProps } from "./types";

export const codegenResultId = "codegen-result";
export const codegenResultLabel = "Halaman Codegen Result";
export const codegenResultPageNumber = 12;
...
export default function CodegenResultSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section className={presentationClass} aria-label="Codegen Result Page">
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-emerald-200/60">
          {formatPageNumber(codegenResultPageNumber, slideCount)}
        </span>
      </div>
