...
import screenshot from "../assets/fe-ai-validation.png";

export const aiImplValidationId = "ai-impl-validation";
export const aiImplValidationLabel = "AI Validation";
export const aiImplValidationPageNumber = 11;
...
export default function AIImplValidationSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section
        className={presentationClass}
        aria-label="AI Implementation Validation"
      >
