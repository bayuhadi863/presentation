...
import screenshot from "../assets/fe-ai-transformation.png";

export const aiImplTransformationId = "ai-impl-transformation";
export const aiImplTransformationLabel = "AI Transformation";
export const aiImplTransformationPageNumber = 13;
...
export default function AIImplTransformationSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section
        className={presentationClass}
        aria-label="AI Implementation Transformation"
      >
        <div className="flex flex-col h-full max-w-7xl mx-auto w-full">
          <div className="mb-8">
            ...
            <h2 className="m-0 text-[clamp(1.8rem,3vw,2.8rem)] leading-tight tracking-[-0.04em] font-bold text-white">
              Module: Data Transformation Logic
            </h2>
          </div>
          <div className="flex-1 min-h-0 rounded-3xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm overflow-hidden flex items-center justify-center">
            <img
              src={screenshot}
              alt="AI Assistant Transformation"
