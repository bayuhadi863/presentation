import screenshot from "../assets/codegen-gitlab-pr.png";
import { slideCount } from ".";
import { formatPageNumber } from "./utils";
import type { SlideProps } from "./types";

export const codegenGitlabPRId = "codegen-gitlab-pr";
export const codegenGitlabPRLabel = "Hasil Codegen, Gitlab Pull Request";
export const codegenGitlabPRPageNumber = 13;
...
export default function CodegenGitlabPRSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section
        className={presentationClass}
        aria-label="Hasil Codegen Gitlab Pull Request"
      >
        <div className="flex flex-col h-full max-w-7xl mx-auto w-full">
          <div className="mb-8">
            ...
            <h2 className="m-0 text-[clamp(1.8rem,3vw,2.8rem)] leading-tight tracking-[-0.04em] font-bold text-white">
              Hasil Codegen, Gitlab Pull Request
            </h2>
          </div>
          <div className="flex-1 min-h-0 rounded-3xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm overflow-hidden flex items-center justify-center">
            <img
              src={screenshot}
              alt="Hasil Codegen Gitlab Pull Request"
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-emerald-200/60">
          {formatPageNumber(codegenGitlabPRPageNumber, slideCount)}
        </span>
      </div>
