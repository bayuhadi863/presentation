import screenshot from "../assets/codegen-swagger.png";
import { slideCount } from ".";
import { formatPageNumber } from "./utils";
import type { SlideProps } from "./types";

export const codegenSwaggerId = "codegen-swagger";
export const codegenSwaggerLabel = "Hasil Swagger";
export const codegenSwaggerPageNumber = 15;
...
export default function CodegenSwaggerSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section className={presentationClass} aria-label="Hasil Swagger">
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-emerald-200/60">
          {formatPageNumber(codegenSwaggerPageNumber, slideCount)}
        </span>
      </div>
