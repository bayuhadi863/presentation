import screenshot from "../assets/codegen-gitlab-commit.png";
import { slideCount } from ".";
import { formatPageNumber } from "./utils";
import type { SlideProps } from "./types";

export const codegenGitlabCommitId = "codegen-gitlab-commit";
export const codegenGitlabCommitLabel = "Hasil Codegen, Gitlab Commit";
export const codegenGitlabCommitPageNumber = 14;
...
export default function CodegenGitlabCommitSlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section
        className={presentationClass}
        aria-label="Hasil Codegen Gitlab Commit"
      >
        <div className="flex flex-col h-full max-w-7xl mx-auto w-full">
          ...
          <div className="flex-1 min-h-0 rounded-3xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm overflow-hidden flex items-center justify-center">
            <img
              src={screenshot}
              alt="Hasil Codegen Gitlab Commit"
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-emerald-200/60">
          {formatPageNumber(codegenGitlabCommitPageNumber, slideCount)}
        </span>
      </div>
