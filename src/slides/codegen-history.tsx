import screenshot from "../assets/codegen-history.png";
import { slideCount } from ".";
import { formatPageNumber } from "./utils";
import type { SlideProps } from "./types";

export const codegenHistoryId = "codegen-history";
export const codegenHistoryLabel = "Halaman Codegen Job History";
export const codegenHistoryPageNumber = 10;
...
export default function CodegenHistorySlide({ mode }: SlideProps) {
  if (mode === "presentation") {
    return (
      <section
        className={presentationClass}
        aria-label="Codegen Job History Page"
      >
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-emerald-200/60">
          {formatPageNumber(codegenHistoryPageNumber, slideCount)}
        </span>
      </div>
